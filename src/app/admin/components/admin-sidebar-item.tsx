...
export default function AdminSidebarItem({ text, icon, selected = false, onClick }: IAdminSidebarItemProps) {
  ...
  return (
    <div className={itemClasses}>
      {icon && <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center">{icon}</div>}
