// TYPES
import { ILogoIpsumProps } from '@/components/logo/types';

// STYLES
import { VARIANT_CLASSES } from '@/components/logo/styles';

export default function LogoIpsum({ variant = 'regular' }: ILogoIpsumProps) {
  return (
    <svg
      width="169"
      height="40"
